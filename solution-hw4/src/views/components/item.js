...
import GlazingSelector, {glazingOptions, glazingValues} from "./glazingSelector.js";
...
class Item extends React.Component {
  constructor(props) {
	...
	calcPrice() {
		return (this.props.basePrice + glazingValues[this.state.glazingOptionIndex] ) * this.state.packSize;
	}
    ...
    return (
      <div className="element-container">
        ...
        <GlazingSelector
					...
					onChange={(glazingOptionIndex) => this.setState({glazingOptionIndex})}
				/>
        ...
        <div className="row-content">
          ...
          <div className="content-right add-to-cart">
            <button className="button-add-to-cart link" onClick={()=>this.addToCart()}>
              Add to Cart
            </button>
          </div>
        </div>
